...
class Bullet_e3(pygame.sprite.Sprite):
    ...
    image = pygame.image.load('/Users/Oleg_Litvinov1/Documents/Code/evoman_framework/evoman/images/met.png')
    ...
    def update(self, dt, game):
        ...
        if game.time%2==0:
            self.image = pygame.image.load('/Users/Oleg_Litvinov1/Documents/Code/evoman_framework/evoman/images/met.png')
        else:
            self.image = pygame.image.load('/Users/Oleg_Litvinov1/Documents/Code/evoman_framework/evoman/images/met2.png')
